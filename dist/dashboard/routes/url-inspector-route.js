...
var url_inspector_route_exports = {};
__export(url_inspector_route_exports, {
  GET: () => GET
});
module.exports = __toCommonJS(url_inspector_route_exports);
...
async function GET(req) {
  ...
  if (!rawUrl.trim()) {
    return import_server.NextResponse.json({ error: "Missing URL" }, { status: 400 });
  }
  ...
  if (rows.length === 0) {
    return import_server.NextResponse.json({ total: 0, empty: true });
  }
...
//# sourceMappingURL=url-inspector-route.js.map