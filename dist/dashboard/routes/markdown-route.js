...
function dbPath() {
  const dataDir = import_path2.default.join(process.cwd(), process.env.TA_DATA_DIR ?? "data");
  return import_path2.default.join(dataDir, "ta-data.db");
}
...
var import_better_sqlite3, import_fs2, import_path2, _db, SqliteStore;
...
var reader = new MdxReader({
  contentDir: import_path3.default.join(process.cwd(), process.env.TA_CONTENT_DIR ?? "content"),
